...
public class TestaAgenciaStandard {
    ...
    public static void main(String args[]) {
        ...
        Agencia agencia = new AgenciaStandard("001", banco);
        
        Cliente cliente1 = new Cliente("Cliente 1", "1232323");
        Cliente cliente2 = new Cliente("Cliente 2", "9877845");

        ContaEspecial contaA = new ContaEspecial(1000d,"1111", cliente1, agencia, 700d);
        ContaEspecial contaB = new ContaEspecial(2000d,"1231", cliente2, agencia, 1200d);
        ContaEspecial contaC = new ContaEspecial(500d,"3100", cliente2, agencia, 100d);
